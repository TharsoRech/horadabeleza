...
export const MOCK_PROFESSIONALS_LIST: Professional[] = [
    { id: '1', name: 'Ana Silva', specialty: 'Manicure', rating: 4.8, reviews: 120, bio: 'Expert em gel.', salon: MOCK_SALONS_LIST[0], serviceIds: ['2'], image: '',availableTimes: ["09:00","10:00", "11:00", "12:00", "15:00"]},
